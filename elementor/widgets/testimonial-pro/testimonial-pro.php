...
class Droit_Addons_Testimonial_Pro extends Widget_Base{
    ...
    {
        return esc_html__( 'Testmonial Pro', 'droit-elementor-addons-pro' );
    }
    ...
    public function _content_control(){
        ...
        $this->_dl_pro_testimonials_content_repeater_controls();
        ...
        $this->_dl_pro_testimonials_icon();
        $this->_dl_pro_testimonial_ordering_controls();

    }

    // Testimonial Repeater
    protected function _dl_pro_testimonials_content_repeater_controls()
    {
        ...
        $repeater->add_control(
			'droit_rating',
			[
				'label' => __( 'Rating', 'droit-elementor-addons-pro' ),
        ...
        $repeater->add_control(
            '_dl_pro_testimonial_name', [
                ...
                'default' => __('Enter Name', 'droit-elementor-addons-pro'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            '_dl_pro_testimonial_designation', [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'placeholder' => __('Enter Designation', 'droit-elementor-addons-pro'),
                'default' => __('Enter Designation', 'droit-elementor-addons-pro'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            '_dl_pro_testimonial_text', [
                ...
                'placeholder' => __('Enter Content', 'droit-elementor-addons-pro'),
                'default' => __('Enter Content', 'droit-elementor-addons-pro'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            '_dl_pro_testimonial_image', [
                'label' => __('Client Image', 'droit-elementor-addons-pro'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Testimonial', 'droit-elementor-addons-pro'),
                'show_label' => false,
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        '_dl_pro_testimonial_name' => __('Droitthemes', 'droit-elementor-addons-pro'),
                        '_dl_pro_testimonial_designation' => __('CTO, Droitthemes', 'droit-elementor-addons-pro'),
                        '_dl_pro_testimonial_text' => __(' “Droitadons presents your services with flexible, convenient and multipurpose layouts. You can select your favorite.“', 'droit-elementor-addons-pro'),
                        '_dl_pro_testimonial_image' => Utils::get_placeholder_image_src(),
                    ],
                    [
                        '_dl_pro_testimonial_name' => __('Droitthemes', 'droit-elementor-addons-pro'),
                        '_dl_pro_testimonial_designation' => __('CTO, Droitthemes', 'droit-elementor-addons-pro'),
    ...
    // Testimonial Repeater
    protected function _dl_pro_testimonials_rating()
    {
        $this->start_controls_section(
		...
		$this->add_control(
			'droit_rating_scale',
			[
				'label' => __( 'Rating Scale', 'droit-elementor-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Unmarked Style', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'solid' => [
						'title' => __( 'Solid', 'droit-elementor-addons-pro' ),
						'icon' => 'eicon-star',
					],
					'outline' => [
						'title' => __( 'Outline', 'droit-elementor-addons-pro' ),
						'icon' => 'eicon-star-o',
					],
				],
				'default' => 'solid',
    ...
    // Testimonial Icon
    protected function _dl_pro_testimonials_icon()
    {
        $this->start_controls_section(
			'droit_section_icon',
			[
    ...
    // Ordering Repeater
    public function _dl_pro_testimonial_ordering_controls(){
        $this->start_controls_section(
    ...
    public function _styles_control(){
        ...
        $this->_dl_pro_testimonial_rating_info();
        $this->_dl_pro_testimonial_icon();
    ...
    public function _dl_pro_testimonial_general_style_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => _x('General', 'droit-elementor-addons-pro'),
    ...
    public function _dl_pro_testimonial_content_style_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => _x('Content', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
    ...
    public function _dl_pro_testimonial_client_info()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => _x('Client Info', 'droit-elementor-addons-pro'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Image Size', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Image Position', 'droit-elementor-addons-pro' ),
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Image Spacing', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
    ...
    public function _dl_pro_testimonial_rating_info()
    {
        $this->start_controls_section(
			'section_stars_style',
			[
				'label' => __( 'Stars', 'droit-elementor-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Unmarked Color', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    public function _dl_pro_testimonial_icon()
    {
        $this->start_controls_section(
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Icon Position', 'droit-elementor-addons-pro' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'normal'  => __( 'Normal', 'droit-elementor-addons-pro' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => __( 'Space', 'droit-elementor-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
    ...
    public function _dl_pro_testimonials_slider_navigation_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{wrapper}} .dl_swiper_testimonial_pagination' => 'align-items: {{swiper_testimonial_pagination_dot_alignment}}'
                ],
            ]
        );
        $this->add_responsive_control(
                                        ...
                                        <div class="dl_testimonial_rating">
                                            <?php
                                                ...
                                                <div class="droit-star-rating__wrapper">
                                                    <?php if ( ! Utils::is_empty( $item['droit_rating_title'] ) ) : ?>
                                        ...
                                        <div class="dl_client_info">
                                            <div class="dl_client_info_inner <?php echo 'image_align_' .$_dl_pro_testimonial_image_position ?>">
                                                ...
                                                <div class="dl-testimonial-content">
                                                    <h5 class="dl_name"><?php echo __($item['_dl_pro_testimonial_name'], 'droit-elementor-addons-pro'); ?></h5>
                                                    <p class="dl_position"><?php echo __($item['_dl_pro_testimonial_designation'], 'droit-elementor-addons-pro'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php
