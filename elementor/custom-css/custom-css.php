    ...
    class DL_Custom_CSS
    {
        ...
        public static function url(){
            if (defined('DROIT_ADDONS_PRO_FILE_')) {
                $file = trailingslashit(plugin_dir_url( DROIT_EL_PRO_FILE )). 'modules/custom-css/';
            } else {
        ...
        public static function dir(){
            if (defined('DROIT_ADDONS_PRO_FILE_')) {
                $file = trailingslashit(plugin_dir_path( DROIT_EL_PRO_FILE )). 'modules/custom-css/';
            } else {
        ...
        public function init()
        {
            add_action( 'elementor/editor/after_enqueue_scripts', function() {              
                wp_enqueue_script("dl-custom-css", self::url() . 'js/custom.js', ['jquery'], self::version(), true);
             } 
            );
        ...
        public function _droit_custom_css( Element_Base $el ) {
            $el->start_controls_section(
                ...
                [
                    'label' => __( 'Custom CSS', 'droit-elementor-addons-pro' ) . _droit_get_icon() ,
            ...
            $el->add_control(
                ...
                [
                    'raw' => __( 'Add your own custom CSS here', 'droit-elementor-addons-pro' ),
            ...
            $el->add_control(
                ...
                [
                    ...
                    'label' => __( 'Custom CSS', 'droit-elementor-addons-pro' ),
                    'language' => 'css',
                    'render_type' => 'ui',
                    'show_label' => false,
                    'separator' => 'none',
            ...
            $el->add_control(
                ...
                [
                    'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'droit-elementor-addons-pro' ),
                    'type' => Controls_Manager::RAW_HTML,
