...
class Button_Hover_Advanced extends \Elementor\Group_Control_Base
{
    ...
    {
        return 'droit-button-hover-advanced';
    }
    ...
    protected function init_fields()
    {
        ...
        $fields['button_transition_type'] = [
            'label' => esc_html__('Transition Type', 'droit-elementor-addons-pro'),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'linear' => 'Linear',
                'ease' => 'Ease',
        ...
        $fields['button_transition'] = [
            'label' => esc_html__('Transition Duration', 'droit-elementor-addons-pro'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['%'],
            'range' => [
                'px' => [
            ...
            'render_type' => 'ui',
            'selector_value' => 'transition: all {{SIZE}}s {{button_transition_type.VALUE}}',
        ];
        $fields['allow_box_shadow'] = [
            'label' => esc_html__('Enable Shadow', 'droit-elementor-addons-pro'),
        ...
        $fields['button_shadow'] = [
            'label' => esc_html__('Shadow', 'droit-elementor-addons-pro'),
    ...
    protected function prepare_fields($fields)
    {
        array_walk(
            $fields, function (&$field, $field_name) {
                ...
                if (in_array($field_name, ['after_setting', 'popover_toggle'])) {
                    return;
                }
    ...
    protected function get_default_options()
    {
        return [
            'popover' => [
                'starter_name' => 'after_setting',
                'starter_title' => esc_html__('After Setting', 'droit-elementor-addons-pro'),
                'settings' => [
                    'render_type' => 'ui',
                    'groupType' => 'after_setting',
                    'global' => [
                        'active' => true,
                    ],
                ],
