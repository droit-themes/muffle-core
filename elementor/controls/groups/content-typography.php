...
class Content_Typography extends \Elementor\Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => esc_html__( 'Family', 'droit-elementor-addons-pro' ),
		...
		$fields['font_weight'] = [
			'label' => esc_html__( 'Weight', 'droit-elementor-addons-pro' ),
		...
		$fields['text_transform'] = [
			...
			'options' => [
				'' => __( 'Default', 'droit-elementor-addons-pro' ),
				'uppercase' => esc_html__( 'Uppercase', 'droit-elementor-addons-pro' ),
				'lowercase' => esc_html__( 'Lowercase', 'droit-elementor-addons-pro' ),
				'capitalize' => esc_html__( 'Capitalize', 'droit-elementor-addons-pro' ),
				'none' => esc_html__( 'Normal', 'droit-elementor-addons-pro' ),
			],
		];
		...
		$fields['font_style'] = [
			...
			'options' => [
				'' => __( 'Default', 'droit-elementor-addons-pro' ),
				'normal' => esc_html__( 'Normal', 'droit-elementor-addons-pro' ),
				'italic' => esc_html__( 'Italic', 'droit-elementor-addons-pro' ),
				'oblique' => esc_html__( 'Oblique', 'droit-elementor-addons-pro' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => esc_html__( 'Decoration', 'droit-elementor-addons-pro' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'droit-elementor-addons-pro' ),
				'underline' => esc_html__( 'Underline', 'droit-elementor-addons-pro' ),
				'overline' => esc_html__( 'Overline', 'droit-elementor-addons-pro' ),
				'line-through' => esc_html__( 'Line Through', 'droit-elementor-addons-pro' ),
				'none' => esc_html__( 'None', 'droit-elementor-addons-pro' ),
			],
		];

		$fields['line_height'] = [
			'label' => esc_html__( 'Line-Height', 'droit-elementor-addons-pro' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => esc_html__( 'Letter Spacing', 'droit-elementor-addons-pro' ),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => -5,
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Typography', 'droit-elementor-addons-pro' ),
				'settings' => [
					'render_type' => 'ui',
